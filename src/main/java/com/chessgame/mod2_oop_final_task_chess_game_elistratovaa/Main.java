...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("""
               ...
               'castling0' или 'castling7' - для рокировки влево(castling0) для или вправо(castling7) для Turn Player 
        ...
        while (true) {
            ...
            if (s.equals("exit")) break;
                ...
                if (s.equals("castling0")) {
                    if (board.castling(0)) {
                        System.out.println("Рокировка влево удалась");
                        board.printBoard();
                    } else {
                        System.out.println("Рокировка влево не удалась");
                    }
                } else if (s.equals("castling7")) {
                    if (board.castling(7)) {
                        System.out.println("Рокировка вправо удалась");
                        board.printBoard();
                    } else {
                        System.out.println("Рокировка вправо не удалась");
                    }
